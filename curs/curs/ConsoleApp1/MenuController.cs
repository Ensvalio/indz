    ...
    public class MenuController {
        ...
        private void AddMarkToStudent() {
            ...
            try {
                ...
                if (!IsValidIndex(studentIndex, students.Count)) {
                    throw new Exception();
                }
                ...
                if (!IsValidIndex(subjectIndex, subjects.Count)) {
                    throw new Exception();
                }
        ...
        private void ShowStudentInfo() {
            ...
            try {
                ...
                if (!IsValidIndex(index, students.Count)) {
                    throw new Exception();
                }
        ...
        private void ShowTeacherInfo() {
            ...
            try {
                ...
                int index = int.Parse(Console.ReadLine());
                if (!IsValidIndex(index, teachers.Count)) {
                    throw new Exception();
                }
        ...
        private void AssignStudentToTeacher() {
            ...
            try {
                ...
                if (!IsValidIndex(teacherIndex, teachers.Count)) {
                    throw new Exception();
                }
        ...
        private void CalculateFinalMark() {
            ...
            try {
                ...
                Pause($"Загальна оцінка з {subject}: {finalMark}");
            }
            catch {
